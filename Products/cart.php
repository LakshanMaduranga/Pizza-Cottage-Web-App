...
if(!empty($_SESSION["shopping_cart"])) {
	foreach($_SESSION["shopping_cart"] as $key => $value) {
		...
		Product buy is successfull & removed from your buy now cart!</div>";
		}
		if(empty($_SESSION["shopping_cart"]))
...
<html>
<head>
<title>Buy Now List</title>
<link rel='stylesheet' href='lakshan.css' type='text/css' media='all' />
</head>
<body>
...
<div class="cart_div">
<a href="cart.php">
<img src="cart-icon.png" /> Buy Here
...
?>
<tr>
<td><img src='<?php echo $product["image"]; ?>' width="200" height="160" /></td>
<td><?php echo $product["name"]; ?><br />
<form method='post' action=''>
<input type='hidden' name='code' value="<?php echo $product["code"]; ?>" />
<input type='hidden' name='action' value="remove" />
<button type='submit' class='remove'>Buy & remove from cart</button>
</form>
</td>
<td>
<form method='post' action=''>
...
<strong>TOTAL: <?php echo "$".$total_price; ?></strong>
  ...
  <?php
	...
	echo "<h3>You Don't have any item to Buy  </h3>";
	}
?>
</div>
